...
class JHtmlTest extends TestCase
{
	...
	public function testImage()
	{
		...
		$this->removeDir(JPATH_THEMES . '/' . $template);
		...
		$this->removeDir(JPATH_ROOT . '/media/' . $urlpath);
		...
		$this->removeDir(JPATH_ROOT . '/media/' . $extension);
		...
		$this->removeDir(JPATH_ROOT . '/media/system/images/' . $element);
		...
		$this->removeDir(JPATH_ROOT . '/test');
	...
	public function testScript()
	{
		...
		JFactory::$document->_scripts = array();
		$this->removeDir(JPATH_ROOT . '/media/system/js/' . $element);
	...
	public function testStylesheet()
	{
		...
		JFactory::$document->_styleSheets = array();
		$this->removeDir(JPATH_ROOT . '/media/system/css/' . $element);
